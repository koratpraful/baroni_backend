...
export const RecordingSteps = {
  ...
  DURATION_REPORT_RECEIVED: 'DURATION_REPORT_RECEIVED', // every reportCallDuration request (see if endCall ever received)
  ...
  RECORDING_STOP_SKIPPED: 'RECORDING_STOP_SKIPPED', // endCall true but no active recording to stop
